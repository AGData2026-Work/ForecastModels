...
class TestCheckpointRoundTrip:
    def test_save_and_load_reproduces_identical_predictions(self, toy_training_data, tmp_path):
        """The whole point of persisting a model (D-63): loading it back
        must reproduce exactly what the original in-memory model would
        have predicted, not an approximation."""
